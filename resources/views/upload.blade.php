...
<body>
    ...
    <div class="container-fluid d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="{{ url('/upload') }}" class="active">Incarca Imagini</a></li>
          <li>
  ...
  <main id="main" data-aos="fade" data-aos-delay="1500">
    ...
    <div class="col-lg-9">
    <form action="{{ route('image') }}" method="POST" enctype="multipart/form-data" class="form">
        @csrf
        ...
        <div class="form-group">
            <button type="submit" class="btn btn-primary">Incarca Imaginea</button>
        </div>
    </form>
