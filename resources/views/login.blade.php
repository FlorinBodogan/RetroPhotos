...
<body>
    ...
    <div class="container-fluid d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="{{ url('/login') }}" class="active">Logare</a></li>
        </ul>
      </nav><!-- .navbar -->
  ...
  <main id="main" data-aos="fade" data-aos-delay="1500">
        ...
        <div class="row d-flex justify-content-center">
          <div class="col-lg-6 text-center">
            ...
            @if(Session::has('error'))
                    <div class="alert" style="font-size:2rem; color:red"; role="alert">
                    {{ Session::get('error') }}
            @endif
          </div>
        </div>
    ...
    <!-- ======= LOGARE ======= -->
    <section id="contact" class="contact" style="height: 60vh;">
      <div class="container">
        </div>
  ...
  <div class="col-lg-9">
        <form action="{{ route('login') }}" method="post" role="form" class="form">
              ...
              <div class="text-center"><button type="submit">Intra in Cont</button></div>
        </form>
