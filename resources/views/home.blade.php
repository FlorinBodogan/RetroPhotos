  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a href="{{ url('/') }}" class="active">Acasa</a></li>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-6 text-center">
          <h2>I'm <span>Florin</span> , Web Developer</h2>
          <p>Aici este locul unde poti posta poze vechi care iti starnesc amintiri.</p>
          <a href="{{ url('/login') }}" class="btn-get-started">Posteaza o poza</a>
        </div>
      </div>
    </div>
